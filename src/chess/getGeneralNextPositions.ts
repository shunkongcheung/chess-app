...
const getGeneralNextPositions = (board: Board, piecePosition: Position) => {
...
const getGeneralFlyPosition = (board: Board, piecePosition: Position) => {
  const curPiece = board[piecePosition[0]][piecePosition[1]];
  ...
  if (board[curPos[0]][curPos[1]].toUpperCase() !== CHS_GENERAL.toUpperCase())
    return [];
...
export const getGeneralInBound = (curPiece: string, nextPosition: Position) => {
